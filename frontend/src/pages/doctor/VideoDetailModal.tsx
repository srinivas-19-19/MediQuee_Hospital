            ...
            <div className="p-6 flex flex-col gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-1">
                    <span className="text-[13px] font-semibold text-gray-500">ID: {appointment?.mqId || "—"}</span>
                    <span className="w-1 h-1 rounded-full bg-gray-300"></span>
                    <span className="text-[13px] font-semibold text-gray-500">{appointment?.age ? `${appointment.age} yrs` : "—"}</span>
                    <span className="w-1 h-1 rounded-full bg-gray-300"></span>
                    <span className="text-[13px] font-semibold text-gray-500">{appointment?.gender || "—"}</span>
                  </div>
              ...
              {(appointment?.status === 'WAITING' || appointment?.status === 'IN PROGRESS') && (
                <div className="flex flex-col gap-3 mt-2">
                  ...
                  <span className="text-[12px] font-medium text-gray-400">System check unavailable.</span>
                </div>
              )}
            </div>
